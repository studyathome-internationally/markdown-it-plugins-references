  ...
  it("enable", () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      ...
      <figure id="client-overview">
        ...
        <figcaption>
          <a href="#client-overview" class="label">Table 1</a>: Client overview
        </figcaption>
      </figure>
      <h2 id="list-of-tables" class="list">List of Tables</h2>
      <ol class="list">
  ...
  it("class", () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      ...
      <figure id="client-overview">
        ...
        <figcaption>
          <a href="#client-overview" class="table-label-anchor">§</a><a href="#client-overview" class="label">Table 1</a>: Client overview
        </figcaption>
      </figure>
      <h2 id="list-of-tables" class="list">List of Tables</h2>
      <ol class="list">
